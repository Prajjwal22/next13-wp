      ...
      <div className={styles.footerWrapper}>
        ...
        <div className={styles.footerContent}>
          ...
          <div className={styles.footerNav}>
            {footerMenu.map((navLink:MenuItems) => {
              return (
                <span key={navLink.id} className={styles.navLink}>
                  <Link href={navLink.uri}>{navLink.label}</Link>
                </span>
              );
            })}
          </div>
        ...
        <div className={styles.copyRight}>
          ...
          <span className={styles.copyRightText}>Made ❤️ by Bunny Ji.</span>
        </div>
      </div>
    </div>
  );
